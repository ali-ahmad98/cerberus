                                    ...
                                    <tbody>\
                                        <tr>\
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #666666; text-align:left;line-height: 24px;">\
                                                <p>Hello {{ name }}</p>\
                                                <p>You have request for reset your current password. Please click on this link to reset your password:\
                                                <br>\
                                                <a  href={{ resetLink }}> <button style = "background-color: #4CAF50;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;">Reset Password</button>\ </a> </p>\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td width="100%" height="5">\
                                            <p>\
                                            The link is valid for 5 minutes. Please ignore this mail if you have already reset your password.\
                                           </p>\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #666666; text-align:left;line-height: 20px;">\
                                                <p>Best regards,</p>\
                                                <p>Team {{ site_name }}</p>\
                                                <div><img src="{{ logo }}" alt="logo" border="0" style="display:flex; border:none; outline:none; text-decoration:none;width:30%;justify-content:left" ></div>\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td width="100%" height="5"></td>\
