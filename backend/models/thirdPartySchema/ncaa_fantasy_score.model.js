...
const ncaaFantasyScoreSchema = new mongoose.Schema({
    // stat_id: { type: Number },
    team_id: { type: Number },
    ...
    std_ftp:{type:Number},
    half_ppr_ftp:{type:Number},
    half_ppr_tep_ftp:{type:Number},
    ppr:{type:Number},
    ppr_tep:{type:Number},
    sfb:{type:Number},
...
const ncaaFantasyScore = new mongoose.model("ncaa_fantasy_score", ncaaFantasyScoreSchema);
module.exports = ncaaFantasyScore;