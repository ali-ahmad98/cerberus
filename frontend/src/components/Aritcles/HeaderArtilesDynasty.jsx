...
const HeaderArtilesDynasty = ({ catName, dataList }) => {
  return (
    <>
          ...
          <div className="row">
            <div className="col-12">
              <div className="py-4 py-md-5">
                <h1 className="heading white font-web skew-heading text-uppercase"> {catName} </h1>
                <HeadingDotted />
              </div>
            </div>
            <div className="col-12 col-xxl-6 ">
              <div className="pe-xxl-5 position-relative">
...
export default HeaderArtilesDynasty;
