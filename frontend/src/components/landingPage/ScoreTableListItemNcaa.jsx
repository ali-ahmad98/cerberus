...
const ScoreTableListItemNcaa = ({ team }) => {
  return (
    <>
          ...
          <div className="row align-items-center ncaafRespWdth mx-0 my-3 py-1">
            <div className="col-sm-7 col-8 d-flex align-items-center">
              <div className="score-board-table-img me-3 d-inline-block position-relative">
                <img
                  src={GlobalConfig.API_URL + "../../uploads/" + team?.awayTeam?.logo_standard}
                  alt="horseImg"
                />
              </div>
              <span className="ps-6 font-18 fw-normal">{team.awayTeam.team_name}</span>
            </div>
            <div className="col-sm-3 col-4">
              <p className="mb-0 font-16 fw-normal">
                {team.awayTeamScore.totalscore}-{team.homeTeamScore.totalscore}
              </p>
            </div>
            ...
            <div className="col-sm-7 col-8 d-flex align-items-center">
              <div className="score-board-table-img-2 me-3 d-inline-block position-relative">
                <img
                  src={GlobalConfig.API_URL + "../../uploads/" + team?.homeTeam?.logo_standard}
                  alt="textImg"
                />
              </div>
            ...
            <div className="col-sm-5 col-4">
              <p className="mb-0 font-16 fw-normal">
                {team.homeTeamScore.totalscore}-{team.awayTeamScore.totalscore}
              </p>
            </div>
          </div>
        </div>
...
export default ScoreTableListItemNcaa;
