...
import { teamLeftBorderColor } from "../../components/nfl-team/Helper";
...
const AmericanFootballStandings = () => {
  ...
  for (let i = currentYear; i >= currentYear - 1; i--) {
    yearDropdown.push(
      <option selected={i === 2022 ? true : false} value={i} key={i}>
        {i}
      </option>
    );
  }
    ...
    <div className="pb-5 mb-5">
      <div className="scoreboard-page-bg d-flex flex-column">
        ...
        <div className="d-flex flex-column align-items-center justify-content-center mt-1 pt-5">
          ...
          <h1 className="font-42 white fw-bold">
            {allNflYear ? "STANDINGS -" + allNflYear : "STANDINGS -" + 2022}
          </h1>
        </div>
      </div>
      ...
      <div className="container pt-5">
        <div className="row  flex-column flex-lg-row justify-content-between ps-sm-5 px-2 ">
          <div className="col ps-md-4 colFlx">
            <button
              className={`${
                                ...
                                >
                                  <td className="text-start py-3 font-16 fw-normal  lh-35 ">
                                    <div className="teamsImgs tIb">
                                      ...
                                      <span
                                        className="leftbordr1"
                                        style={{ backgroundColor: teamLeftBorderColor[index] }}
                                      ></span>
                                    </div>
