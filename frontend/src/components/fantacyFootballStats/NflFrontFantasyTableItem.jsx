const NflFrontFantasyTableItem = ({ allNflList }) => {
  return (
    <>
      <div className="mt-5 pt-5 min-w-280">
        ...
        {allNflList?.response_data?.NFL.length != 0 &&
          allNflList?.response_data?.NFL.map((item, index) => {
            return (
              <div
                  ...
                  <tr className={`${index <= 4 ? "bg-gray-123" : ""}`} key={item._id}>
                    ...
                    <td className="text-start border-top-0 text-center font-14 fw-normal px-4">
                      {item?.team_details?.team_id === item?.opponent[0]?.awayTeam?.team_id
                        ? item?.opponent[0]?.homeTeam?.team_code
                        : item?.opponent[0]?.awayTeam?.team_code}
                    </td>
                    ...
                    <td className="text-start border-top-0  text-center font-14 fw-normal px-4">
                      {item?.Defense[0]?.assisted_tackles
                        ? item?.Defense[0]?.assisted_tackles
                        : "0"}
                    </td>
                    <td className="text-start border-top-0  text-center font-14 fw-normal px-4">
...
export default NflFrontFantasyTableItem;
