...
import { ncaaPlayerGameLogApi } from "../../service/NcaaService";
import ColorRingCustomLoader from "../common/ColorRingCustomLoader";

const GameLogTableNcaa = ({ playerId, playerDetails }) => {
  ...
  useEffect(() => {
    async function getNcaaPlayerGameLog() {
      ncaaPlayerGameLogApi(playerId, yearNo).then(function (result) {
  ...
  const onChageDropdown = () => {
    ...
    navigate(`/ncaaf/player-profile/${playerId}?year=${yearSelect}`);
                              ...
                              <tr key={index} className="gamelog-tr">
                                ...
                                <td className="font-16 fw-light blue" colSpan="2">
                                  ...
                                  {playerDetails.team_id == val.awayTeamDetails.team_id ? (
                                    <>
                                      <span
                                        className={`color-red pe-2 ${
                                          val.awayTeamScore.totalscore >
                                          val.homeTeamScore.totalscore
                                            ? "color-green"
                                            : ""
                                        }`}
                                      >
                                        {val.awayTeamScore.totalscore > val.homeTeamScore.totalscore
                                          ? "W"
                                          : "L"}
                                      </span>
                                      {val.awayTeamScore.totalscore}-{val.homeTeamScore.totalscore}
                                    ...
                                    <>
                                      ...
                                      {val.homeTeamScore.totalscore}-{val.awayTeamScore.totalscore}
                                    </>
                                  )}
                                </td>
                                ...
                                {playerDetails?.team_id == val?.awayTeamDetails?.team_id ? (
                                  <>
                                    ...
                                    {/* <td className="font-16 fw-light p-0 color-grey">--</td> */}
                                    ...
                                    <td className="font-16 fw-light p-0 color-grey">
                                      {val?.passing?.awayteam?.player?.length > 1
                                        ? val?.passing?.awayteam?.player[0]?.sacks >= 1
                                          ? val?.passing?.awayteam?.player[0]?.sacks
                                          : 0
                                        : val?.passing?.awayteam?.player?.sacks >= 1
                                        ? val?.passing?.awayteam?.player?.sacks
                                        : 0}
                                    </td>
                                    <td className="font-16 fw-light p-0 color-grey">
                                      {val?.passing?.awayteam?.player?.length > 1
                                        ? val?.passing?.awayteam?.player[0]?.rating >= 1
                                          ? val?.passing?.awayteam?.player[0]?.rating
                                          : 0
                                        : val?.passing?.awayteam?.player?.rating >= 1
                                  ...
                                  <>
                                    ...
                                    <td className="font-16 fw-light p-0 color-grey">
                                      {val?.passing?.hometeam?.player?.length > 1
                                        ? val?.passing?.hometeam?.player[0]?.sacks >= 1
                                          ? val?.passing?.hometeam?.player[0]?.sacks
                                          : 0
                                        : val?.passing?.hometeam?.player?.sacks >= 1
                                        ? val?.passing?.hometeam?.player?.sacks
                                        : 0}
                                    </td>
                                    <td className="font-16 fw-light p-0 color-grey">
                                      {val?.passing?.hometeam?.player?.length > 1
                                        ? val?.passing?.hometeam?.player[0]?.rating >= 1
                                          ? val?.passing?.hometeam?.player[0]?.rating
                                          : 0
                                        : val?.passing?.hometeam?.player?.rating >= 1
...
export default GameLogTableNcaa;
